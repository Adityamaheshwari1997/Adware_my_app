...
ActiveRecord::Schema[7.0].define(version: 2023_02_20_070348) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["screen_id"], name: "index_users_on_screen_id"
    t.index ["theater_id"], name: "index_users_on_theater_id"
  end
  ...
  add_foreign_key "users", "screens"
  add_foreign_key "users", "theaters"
end
